  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Gestionando el manejo integral de residuos
        p.mb-4 Reforzar los conceptos y elementos para la gestión integral del manejo de residuos, con base en los temas desarrollados en el componente formativo.
